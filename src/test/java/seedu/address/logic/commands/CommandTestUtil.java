...
public class CommandTestUtil {
    ...
    public static void assertCommandFailure(Command command, Model actualModel, String expectedMessage) {
        ...
        List<Person> expectedFilteredList = new ArrayList<>(actualModel.getFilteredList());
     ...
     */
    public static void showPersonAtIndex(Model<Person> model, Index targetIndex) {
        assertTrue(targetIndex.getZeroBased() < model.getFilteredList().size());

        Person person = model.getFilteredList().get(targetIndex.getZeroBased());
